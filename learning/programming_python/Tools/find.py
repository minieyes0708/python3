...
"""
################################################################################
Return all files matching a filename patern at and below a root directory;
...
find() is a generator that uses the os.walk() generator to yeild just
...
def findlist(pattern, startdirs=os.curdir, dosort=False):
